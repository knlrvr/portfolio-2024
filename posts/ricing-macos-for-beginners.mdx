...
There's a few different customization options for Warp that you can read about <BlogLink href='https://docs.warp.dev/appearance/custom-themes'>here</BlogLink>. 
