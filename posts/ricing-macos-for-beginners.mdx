...
<Callout variant='edit'>
	**Edit &mdash; 01/01/25** &nbsp; My terminal of choice is no longer Warp. I now use <BlogLink href="https://ghostty.org/">Ghostty</BlogLink>.
</Callout>
...
<Callout variant='edit'>
	**Edit &mdash; 01/01/25** &nbsp; I no longer use any widgets. Read more about that <BlogLink href="https://www.knlrvr.dev/blog/ricing-macos-part-two">here</BlogLink>.
</Callout>
