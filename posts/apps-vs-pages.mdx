...
As of January 8th, 2024, everything in my portfolio was migrated to the new app router with the support of <BlogLink href='https://nextjs.org/docs/app/building-your-application/upgrading/app-router-migration'>these Next.js docs &nearr;</BlogLink>. It was a relatively easy process, but there are some important notes about behaviors that can make or break an experience that I went through during the migration. 
...
## This Portfolio
As always, all of my work is open source. Visit <BlogLink href='https://github.com/knlrvr/kanelariviere-new'>the repo for my previous portfolio &nearr;</BlogLink> and take a look around!
