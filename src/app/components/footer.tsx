...
export default function Footer() {
    return (
        <div className="border-t border-neutral-200 flex flex-col sm:flex-row space-y-12 sm:space-y-0 justify-between items-start pt-8 text-xs font-light tracking-wider text-neutral-500">
